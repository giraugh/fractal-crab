...
export class FractalCanvas {
    ...
    static __wrap(ptr) {
        const obj = Object.create(FractalCanvas.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_fractalcanvas_free(ptr);
    }
    /**
    ...
    */
    static from_canvas(canvas) {
        try {
            ...
            wasm.fractalcanvas_from_canvas(retptr, addHeapObject(canvas));
            ...
            return FractalCanvas.__wrap(r0);
        } finally {
    ...
    */
    get_view_centre() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.fractalcanvas_get_view_centre(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    set_julia_constant_at(julia_const) {
        var ptr0 = isLikeNone(julia_const) ? 0 : passArrayF32ToWasm0(julia_const, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.fractalcanvas_set_julia_constant_at(this.ptr, ptr0, len0);
    }
    /**
    * @param {number} width
    * @param {number} height
    */
    resize_viewport(width, height) {
        wasm.fractalcanvas_resize_viewport(this.ptr, width, height);
    }
    /**
    * @param {number} x_off
    * @param {number} y_off
    */
    move_view(x_off, y_off) {
        wasm.fractalcanvas_move_view(this.ptr, x_off, y_off);
    }
    /**
    * @param {number} factor
    */
    zoom_view(factor) {
        wasm.fractalcanvas_zoom_view(this.ptr, factor);
    }
    /**
    */
    draw() {
        wasm.fractalcanvas_draw(this.ptr);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('fractal_crab_bg.wasm', import.meta.url);
    }
    const imports = getImports();
